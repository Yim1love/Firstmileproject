...
($.Thailand = function (e) {
  ...
  var t = function (e) {
      ...
      return (
        e.lookup &&
          e.words &&
          ((a = e.lookup.split("|")), (n = e.words.split("|")), (e = e.data)),
        (t = function (e) {
          return (
              ...
              n[a].map(function (o) {
                (o[a] = o[a] instanceof Array ? o[a] : [o[a]]),
                  o[a].map(function (r) {
                    ...
                    2 === a &&
                      ((c.district_code = o[1] || !1),
                      (c.amphoe_code = n[1] || !1),
                      (c.province_code = e[1] || !1)),
                      i.push(c);
                  });
              });
            });
    ...
    a = function (e, t, n) {
      ...
      for (i = 0; i < h; i += 1)
        for (o = 0; o < l; o += 1) {
          for (
            r = 0;
            i + r < h && o + r < l && e.charAt(i + r) === t.charAt(o + r);
      ...
      return (
        (c = d) &&
          (s && p && (c += a(e.substr(0, p), t.substr(0, p), !1)),
          s + d < h &&
            p + d < l &&
            (c += a(
              e.substr(s + d, h - s - d),
  ...
  !(function (a) {
    ...
    switch (
      ("json" !== i && "zip" !== i && (i = e.database.split(".").pop()), i)
    ) {
      case "json":
            ...
            for (n in e)
              (i = n.replace("$", "")),
                n.indexOf("$") > -1 &&
                  ...
                  e[n] &&
                  a[i] &&
                  e[n].typeahead("val", a[i]).trigger("change");
            "function" == typeof e.onDataFill &&
              (delete a.likely, e.onDataFill(a));
          })
          .blur(function () {
