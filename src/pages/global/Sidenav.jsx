...
export default function Sidenav() {
  ...
  const [menudata, setMenudata] = useState("Account");
        ...
        <List>
            ...
            <ListItem disablePadding sx={{ display: 'block' }}>
              ...
              >
                ...
                <ListItemText primary="ความเป็นส่วนตัว" />
              </ListItemButton>
            </ListItem>
            <ListItem disablePadding sx={{ display: 'block' }}>
              <ListItemButton
              ...
              >
                ...
                <ListItemText primary="เครื่องมือค้นหา" />
              </ListItemButton>
            </ListItem>
       
        </List>
        <Divider />
        <Typography sx={{ marginLeft:"20px"}}> เกี่ยวกับระบบ</Typography>
        ...
        <ListItem disablePadding sx={{ display: 'block' }}>
            ...
            <ListItem disablePadding sx={{ display: 'block' }}>
              ...
              >
                ...
                <ListItemText primary="รีเซ็ตการตั้งค่า" />
              </ListItemButton>
            </ListItem>
            <Divider/>
            <ListItem disablePadding sx={{ display: 'block' }}>
